...
export async function analyzeSession(summary: SessionSummary): Promise<AiSessionInsight> {
...
`
  ...
  try {
    ...
    return {
      narrativeSummary: 'The AI analyst could not produce a structured result for this session.',
      topRisks: []
    }
  }
